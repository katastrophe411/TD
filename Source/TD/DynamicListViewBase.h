...
#include "DynamicListViewBase.generated.h"


template <typename ItemType>
class ITypedUMGDynamicListView
{
public:
	using NullableItemType = typename SDynamicListView<ItemType>::NullableItemType;
...
protected:
	virtual SDynamicListView<ItemType>* GetMyListView() const = 0;
...
public:
	...
	//////////////////////////////////////////////////////////////////////////
	// Public API to match that of SDynamicListView
	//////////////////////////////////////////////////////////////////////////

	NullableItemType GetSelectedItem() const
	{
		if (SDynamicListView<ItemType>* MyListView = GetMyListView())
		{
	...
	{
		SDynamicListView<ItemType>* MyListView = GetMyListView();
...
protected:
	...
	template <template<typename> class ListViewT = SDynamicListView, typename UListViewBaseT>
	...
	{
		static_assert(TIsDerivedFrom<ListViewT<ItemType>, SDynamicListView<ItemType>>::IsDerived, "ConstructListView can only construct instances of SDynamicListView classes");
...
protected:
	 ...
	 */
	virtual UUserWidget& OnGenerateEntryWidgetInternal(ItemType Item, TSubclassOf<UUserWidget> DesiredEntryClass, const TSharedRef<SDynamicTableViewBase>& OwnerTable) = 0;
...
private:
	TSharedRef<ITableRow> HandleGenerateRow(ItemType Item, const TSharedRef<SDynamicTableViewBase>& OwnerTable)
	{
...
class UDynamicListViewBase : public UWidget
{
	GENERATED_BODY()
	
public:
	UDynamicListViewBase(const FObjectInitializer& ObjectInitializer);
...
protected:
	...
	virtual TSharedRef<SDynamicTableViewBase> RebuildListWidget();
	...
	*/
	...
	template <typename WidgetEntryT = UUserWidget, typename ObjectTableRowT = SObjectDynamicTableRow<UObject*>>
	WidgetEntryT& GenerateTypedEntry(TSubclassOf<WidgetEntryT> WidgetClass, const TSharedRef<SDynamicTableViewBase>& OwnerTable)
	{
		...
		WidgetEntryT* ListEntryWidget = EntryWidgetPool.GetOrCreateInstance<WidgetEntryT>(*WidgetClass,
			[this, &OwnerTable] (UUserWidget* WidgetObject, TSharedRef<SWidget> Content)
			{
				return SNew(ObjectTableRowT, OwnerTable, *WidgetObject, this)
					...
					.OnHovered_UObject(this, &UDynamicListViewBase::HandleListEntryHovered)
					.OnUnhovered_UObject(this, &UDynamicListViewBase::HandleListEntryUnhovered)
					[
						Content
					];
			});
...
private:
	...
	TSharedPtr<SDynamicTableViewBase> MyTableViewBase;

	friend class FListViewBaseDetails;
};


#define IMPLEMENT_TYPED_UMG_DYNAMIC_LIST(ItemType, ListPropertyName)	\
protected:	\
	virtual SDynamicListView<ItemType>* GetMyListView() const override { return ListPropertyName.Get(); }	\
...
private:	\
	friend class ITypedUMGDynamicListView<ItemType>;	\
